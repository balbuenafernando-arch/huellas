    ...
    <main className="container py-6">
      ...
      <form onSubmit={submit} className="grid gap-5 lg:grid-cols-[1fr_.8fr]">
        <section className="form-card space-y-4">
          ...
          <div><label className="label">Descripción</label><textarea required className="textarea min-h-28" name="descripcion" placeholder="Color, collar, señas particulares, temperamento..." /></div>
          <div><label className="label">Alias o nombres alternativos</label><input className="field" name="alias" placeholder="Lunita, Lulu" /></div>
        ...
        <section className="form-card space-y-4">
          ...
          <div><label className="label">Dirección o referencia</label><input required className="field" name="direccion" placeholder="Parque, avenida, último lugar visto" /></div>
