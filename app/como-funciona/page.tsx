...
const steps = [
  ...
  { icon: Link2, title: "HUELLA conecta la información", body: "El centro de búsqueda reúne el mapa, los avistamientos y las novedades del caso." },
    ...
    <main className="container py-6">
      <section className="mx-auto max-w-3xl">
        ...
        <section className="mt-6 grid gap-3 md:grid-cols-2">
          <div className="form-card"><h2 className="font-bold">Centro de búsqueda</h2><p className="mt-2 text-sm text-[#6B6860]">Reúne los datos de la mascota, sus fotos, el mapa, los avistamientos y el estado del caso.</p></div>
