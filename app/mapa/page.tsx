...
export default function MapaPage() {
  ...
  useEffect(() => { listReports(true).then((reports) => setPets(reports.map(reportToLegacyPet))).finally(() => setLoading(false)); }, []);
  ...
  return (
    <main className="container py-6">
      ...
      {filtered.length === 0 && <div className="form-card empty-state mt-5 text-sm"><span className="text-4xl" aria-hidden="true">🗺️</span><strong>No hay casos para mostrar en este mapa.</strong><span>Cuando se publique una búsqueda, podrás verla aquí.</span></div>}
