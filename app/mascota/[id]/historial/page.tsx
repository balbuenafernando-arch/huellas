  ...
  return (
    <main className="container py-6">
      <section className="form-card mx-auto max-w-2xl">
        ...
        <p className="mt-2 text-sm text-[#6B6860]">Búsquedas anteriores de esta mascota.</p>
        <div className="mt-5 space-y-3">
          {items.length === 0 && <p className="text-sm text-[#6B6860]">Aún no hay búsquedas anteriores. Eso también es una buena señal.</p>}
