      ...
      <section className="container md:hidden">
        {view === "lista" ? (
          ...
          <div className="relative h-[calc(100dvh-220px)] min-h-[520px] overflow-hidden rounded-2xl">
            ...
            <div className="absolute inset-x-0 bottom-[calc(78px+env(safe-area-inset-bottom))] z-40 max-h-[42%] overflow-y-auto overscroll-contain rounded-t-3xl border border-black/10 bg-white/95 p-3 shadow-[0_-12px_28px_rgba(0,0,0,.12)] backdrop-blur">
